			...
			<div class="container-fluid">
				...
				<div class="card">
					<div align="center">
						...
						명
						<!-- profile 계정의 팔로워랑 계정 차단 비교 -->
						<c:forEach var="fl" items="${pfollowerList}" varStatus="status">
							<c:set var="blockcount" value="0" />
							<c:forEach var="bl" items="${pfollowerBlockList}">
							...
							<c:if test="${blockcount eq '0' }">
								...
								<c:forEach var="bl" items="${followerBlockList}">
									<c:if test="${fl.ucode eq bl.bopcode}">
