			...
			<div class="container-fluid">
				...
				<div class="input-group col-auto">
					...
					<form class="form-inline mt-2 mt-md-0" action="">
						<input type="text" class="form-control input-sm float-end" name="searchMember" id="searchMember">
						<button type="submit" class="btn btn-success float-end">검 색</button>
					</form>
				</div>
				<!--글 정렬-->
								...
								<div class="card-body">
									<c:choose>
										...
										<c:otherwise>
											...
											<span class="ban"><button type="button" class="btn btn-danger float-right ${status.index }">탈퇴</button></span>
											<span class="unban"><button type="button" class="btn btn-primary float-right ${status.index }">복원</button></span>
