		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card">
					<div class="card-body">
						<div class="form-group">
							<form class="well form-search" action="searchView">
								<input type="text" class="input-medium search-query" />
								<button type="submit" class="btn btn-success float-center">Search</button>
							</form>
						</div>
					</div>
				</div>
				...
				<div class="list-group list-group-horizontal">
					<a href="like" class="list-group-item list-group-item-action">인기</a> 
					<a href="user"	class="list-group-item list-group-item-action">사용자</a> 
					<a href="new"	class="list-group-item list-group-item-action">최신글</a>
					<a href="photo" class="list-group-item list-group-item-action">사진</a>
					<a href="vedio" class="list-group-item list-group-item-action">동영상</a>
				</div>
